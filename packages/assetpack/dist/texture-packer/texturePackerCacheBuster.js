...
export function texturePackerCacheBuster() {
    ...
    return {
        ...
        async transform(asset, _options) {
        ...
        async finish(asset) {
            ...
            for (let i = jsonAssets.length - 1; i >= 0; i--) {
                ...
                if (json.meta.related_multi_packs) {
                    json.meta.related_multi_packs = json.meta.related_multi_packs.map((pack) => {
                        const foundAssets = findAssets((asset) => asset.filename === pack, asset, true);
...
//# sourceMappingURL=texturePackerCacheBuster.js.map